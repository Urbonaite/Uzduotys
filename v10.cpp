...
int main(){
    int num_of_std; int budas; int st_kiekis=20000; int paz_kiekis=4; int geri_kiekis=0; int blogi_kiekis=0; 
    string temp; 
    ...
    irasyti_stud(studentai, st_kiekis, "visi20k.txt");

    auto start_0 = chrono::high_resolution_clock::now();
    nuskaityti_is_failo(studentai, "visi20k.txt", 0);
    auto end_0 = chrono::high_resolution_clock::now();
    chrono::duration<double> diff_0 = end_0 - start_0;
    cout << "20,000 studentų nuskaitymas iš failo užtruko: " << diff_0.count() << "s \n\n";

    auto start_1 = chrono::high_resolution_clock::now();
    padalinti(studentai_blogi, studentai, budas);
    auto end_1 = chrono::high_resolution_clock::now();
    chrono::duration<double> diff_1 = end_1 - start_1;
    cout << "20,000 studentų padalinimas užtruko: " << diff_1.count() << "s \n\n";
